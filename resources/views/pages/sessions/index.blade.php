    ...
    <x-slot name="header">
        <div class="my-6 flex items-center justify-between">
            ...
            @if(! $cities->isEmpty())
                ...
                @endif
                <x-primary-button-link href="{{ route('cities.create') }}">
                            ...
                            @foreach($City->toArray() as $key => $value)
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="flex items-center space-x-2">
                                        <x-primary-button-link :href="route('cities.edit', $City->id)" class="bg-green-500 dark:bg-green-300">
