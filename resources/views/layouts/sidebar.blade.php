<aside class="z-20 hidden w-80 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0" >
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 flex items-center justify-start text-lg font-bold text-gray-800 dark:text-gray-200"
        href="{{ route('dashboard') }}" >
        <x-main-logo class="w-52"></x-main-logo>
        </a>
        <ul class="mt-6">
            ...
            <x-sidebar-link :href="route('user.index')" :active="request()->routeIs('user.index')" >
                ...
                <span class="ml-4">{{ __('User Management') }}</span>
            </x-sidebar-link>
            <x-sidebar-link :href="route('learning-centers.index')" :active="request()->routeIs('learning-centers.index')" >
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                      </svg>
